...
export const metadata: Metadata = {
  title: "Services",
  description:
    "Website, local SEO, reviews, booking, AI chat, and a weekly insights dashboard — everything modern small businesses need to be found, trusted, and booked.",
};
        ...
        <Container>
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg text-muted-foreground text-balance">
              Six tightly integrated pillars that work together. Buy them as a
              package, or pick the one you need most.
            </p>
          </div>
        </Container>
      </Section>
          ...
          <div className="grid gap-12 lg:grid-cols-[260px_1fr]">
            ...
            <aside className="hidden lg:block">
              <nav
                ...
                className="sticky top-24 space-y-1 border-l border-white/10 pl-6"
              >
                {services.map((s) => (
                  <a
                    key={s.slug}
